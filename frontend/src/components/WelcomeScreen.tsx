    ...
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ minHeight: '100vh', background: `url(/images/blog/logo.png) center center no-repeat`, backgroundSize: '40%', py: 6, display: 'flex', alignItems: 'center', position: 'relative' }}>
        ...
        >
          ...
          <Avatar src={process.env.PUBLIC_URL ? process.env.PUBLIC_URL + '/images/blog/logo.png' : '/images/blog/logo.png'} alt="Deepthink AI Logo" sx={{ width: 80, height: 80, mb: 2, boxShadow: 2 }} />
